...
#ifndef KAIZENSDK_SWIFT_H
#define KAIZENSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KaizenSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BaseComponent (SWIFT_EXTENSION(KaizenSDK)) <WKNavigationDelegate, WKScriptMessageHandler>
...
SWIFT_CLASS("_TtC9KaizenSDK23NVActivityIndicatorView")
